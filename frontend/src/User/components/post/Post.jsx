...
const Post = ({ post, fetchCollegeFeed }) => {
  ...
  const CommentDetails = (fId) => {
    axios.get(`http://localhost:5000/commentDetails/${Id}/${fId}`).then((response) => {
    ...
    <>
      ...
      <div className="post">
        <div className="container">
          <div className="user">
            <div className="userInfo">
              ...
              <div className="details">
                ...
                >
                  <span className="name">{post.CollegeId.name}</span>
                </Link>
          ...
          {commentOpen && <Comments postId={post._id} CommentDetails={CommentDetails} />}
        </div>
      </div>
    </>
  );
